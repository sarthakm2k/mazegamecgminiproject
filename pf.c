 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(5,160," P.A COLLEGE OF ENGINEERING MANGALORE");
	glColor3f(1,1,1);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"Sharthak(4PA19CS089) and Shreehari(4PA19CS093) ");
	...
	glColor3f(1,0,0);
	output(70,40,"Asif mulla Lecturer,Dept. of CSE");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	drawstring(72,30,"(B.E.)",GLUT_BITMAP_HELVETICA_12);

	output(70,20,"Divya jithesh Lecturer,Dept. of CSE");
	glFlush();
